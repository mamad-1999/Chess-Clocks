    ...
    return (
        <section className="flex md:flex-col items-center justify-evenly bg-zinc-800 w-full md:w-20 h-16 md:h-screen text-white">
            <div className="flex md:flex-col items-center justify-evenly w-full h-full">
                <svg onClick={onShowModal} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-9 h-9 stroke-stone-400 cursor-pointer">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                </svg>
                <div onClick={() => !toolBar.playStatus ? onPlay() : onPause()}>
                    {(toolBar.playStatus && timer.startTime) ? (
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-9 h-9 fill-stone-400 stroke-stone-400 cursor-pointer">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5" />
                        </svg>
                    ) : (
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-9 h-9 fill-stone-400 stroke-stone-400 cursor-pointer">
            ...
            <div className="flex md:flex-col items-center justify-evenly w-full h-full">
                <Link href={"/time"} onClick={() => toolBar.playStatus && onPause()}>
